...
namespace RestaurantRaterAPI.Controllers
{
    ...
    public class RestaurantController : Controller
    {
        ...
        {
            var restaurant = await _context.Restaurant.Include(r => r.Ratings).ToListAsync();
            List<RestaurantListItem> restaurantList = _context.Restaurant.Select(r => new RestaurantListItem()
            {
                Id = r.Id,
                Name = r.Name,
                Location = r.Location,
        ...
        {
            var restaurant = await _context.Restaurant.Include(r => r.Ratings).FirstOrDefaultAsync(r => r.Id == id);
            if (restaurant == null)
            {
                return NotFound();
            }
